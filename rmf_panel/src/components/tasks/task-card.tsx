          ...
          <CardContent>
            <Grid container>
              <Grid item xs={12}>
                ...
                <Grid item xs={12}><Button variant="outlined" onClick={() => handleCancel(taskState.task_id)} disabled={ ['Cancelled', 'Completed', 'Failed', 'Killed'].indexOf(currentTaskStatus) != -1 }>Cancel Task</Button></Grid>
            </Grid>
          </CardContent>
